            ...
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="name" required="" lay-verify="required" autocomplete="off" class="layui-input" value="{{$menuinfo['name']}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="root_id">
                            ...
                            <option value="{{$value['menu_id']}}" @if($menuinfo['root_id']==$value['menu_id']) selected @endif>{{$value['name']}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_email" name="display" required="" lay-verify="display" autocomplete="off" class="layui-input" value="{{$menuinfo['display']}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="class_func" name="class_func" required="" lay-verify="class_func" autocomplete="off" class="layui-input" value="{{$menuinfo['class_func']}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="checkbox" title="{{$value}}" value="{{$key}}" name="role_menu" @if(in_array($key,$rolemenuarr)) checked @endif />
                        @endforeach
                    </div>
                </div>
                <input type="hidden" value="{{$menuinfo['menu_id']}}" name="menu_id">
                <div class="layui-form-item">
